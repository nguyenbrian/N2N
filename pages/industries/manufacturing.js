  ...
  return (
    ...
    >
      <p>
        ...
        to minimize the human workforce while improve efficiency and simplify
        the whole manufacturing system. If earlier, more than one person was
        required to manage one task system, then with the implementation of
        AI-based robots, now one bot per task system is sufficient. We are going
        to see very soon 
        <b>
          what roles AI and robotics are playing in the manufacturing industry
        </b>
        .
      </p>
      ...
      <p>
        ...
        . Robots play a highly important role in the production, packing, and
        shipping of products with least manual help. Artificial intelligence and
        robotics, in collaboration with new technology like 3D printing, will
        prove beneficial in bringing advancement in manufacturing and fulfilling
