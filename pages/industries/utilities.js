...
export default function Utilities() {
  return (
    <IndustryPage
      title="Utilities"
      tagline="Using AI to accelerate Digital Transformation at Utilities"
      src="/images/article_utilities.jpg"
    >
      <p>
        Digital transformation in the utilities sector is the process of
        adopting new digital ways of working, often with a business goal for
        utilities to reinvent themselves. Common business goals include improved
        interactions with customers, more streamlined operations, greater
        efficiencies, and hopes of triggering new business models.
      </p>

      <b>Business is benefit of digital transformation in utilities:</b>
      <p>
        Although transformation has been slow to arrive for the utility sector,
        those companies that do implement digital technologies and adopt news
        ways of working can benefit greatly. Utility executives using expert
        systems based on Artificial Intelligence (AI), for example, can gain new
